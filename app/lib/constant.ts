...
export const colors: Colors[] = [
  ...
  {
    color: "linear-gradient(to right, #6EE7B7, #22C55E)",
  },
  {
    color: "linear-gradient(to right, #FDE4ED, #F48FB1)",
  },
  {
    color: "linear-gradient(to right, #A7F3D0, #6EE7B7)",
  },
  {
    color: "linear-gradient(to right, #64E3D5, #F6E05E)",
  },
  {
    color: "linear-gradient(to right, #34D399, #60A5FA)",
  },
  {
    color:
